...
\IEEEauthorblockA{\textit{Institutt for maskin, elektronikk og kjemi} \\ OsloMet – storbyuniversitetet \\ Oslo, Norge\\ s331475@oslomet.no $\cdot$ s331432@oslomet.no \\ s331477@oslomet.no $\cdot$ s330317@oslomet.no}}
% |-- Flere forfatterblokker --|
% \author{\IEEEauthorblockN{Kenneth R. Eikrehagen}
% \IEEEauthorblockA{\textit{ Institutt for maskin, elektronikk og kjemi } \\ OsloMet – storbyuniversitetet \\ Oslo, Norge \\ s331475@oslomet.no}
% \and
% \IEEEauthorblockN{Lars-Erik Ulvund}
% \IEEEauthorblockA{\textit{ Institutt for maskin, elektronikk og kjemi } \\ OsloMet – storbyuniversitetet \\ Oslo, Norge \\ s331432@oslomet.no}
% \and
% \IEEEauthorblockN{Alexsander Kristensen}
% \IEEEauthorblockA{\textit{Institutt for maskin, elektronikk og kjemi} \\ OsloMet – storbyuniversitetet \\ Oslo, Norge \\ s331477@oslomet.no}
% \and
% \IEEEauthorblockN{Erik Johansson}
% \IEEEauthorblockA{\textit{Institutt for maskin, elektronikk og kjemi} \\ OsloMet – storbyuniversitetet \\ Oslo, Norge \\ s330317@oslomet.no}}
...
\section{Metode}
    ...
    \subsection{RobotStudio}
        ...
        \end{equation*}
        og er vist i figur \ref{fig:robotstudio} og \ref{fig:arbeidsområde}
        \begin{figure}[!htb]
            \centering
            \begin{tikzpicture}
                % \draw[style=help lines] (0,0) grid (3,2);
                \filldraw[fill=orange!20!white, draw=orange] (0,0) -- (0,2.5) arc (90:87:2.5) node[orange,above right=-1pt]{$\alpha$} -- (0,0);
                \draw[gray] (0,0) -- node[left] {b} (0,10/3) node[above right=-2.5pt] {a} -- (5,10/3) -- (5,0) -- (0,0);
                \draw[rotate around={-3:(0,0)}] (0,0) -- node[right] {c} (0,10/3) -- (5,10/3) -- (5,0) -- (0,0);
            \end{tikzpicture}
            \caption{}
            \label{fig:arbeidsområde}
        \end{figure}
...
\section{Resultater}
    ...
    Hvordan programmet vi konstruerte oppfattet det som ble fanget på kameraet ser man på figur \ref{resulat:objekt}.
    \begin{figure}[!htb]
        \centering
