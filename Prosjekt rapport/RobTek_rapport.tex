...
\section{Metode}
    ...
    I denne prosjektoppgaven er objektgjenkjenning sammen med ABB-robotarmen brukt til å sortere forskjellige geometriske figurer som vist på figur \ref{fig:metode} på neste side. OpenCV og 
    ...
    \subsection{RobotStudio}
        ...
        arbeidsbordet ble justert ved hjelp av en trigonometrisk funksjon, vinkel $A = tan^{-1}\frac{b}{a}$, og er vist i figur \ref{fig:robotstudio}.
